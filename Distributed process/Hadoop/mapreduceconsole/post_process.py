...
HDFS_RESULT_DIR = "resultconsole"    
SCRIPT_DIR = Path(__file__).resolve().parent
LOCAL_MERGED_FILE = SCRIPT_DIR / "merged_console.txt"
LOCAL_OUTPUT_DIR = SCRIPT_DIR / "output_docs_console"
HDFS_DEST_DIR = "output_docs_console_hdfs"
